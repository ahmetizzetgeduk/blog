    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- İlk içerim bölümü-->
                <div class="card mb-4"
                    style="border:2px solid #F00; color: #000; padding: 0 15px; padding-bottom: 15px;">
                    <h1 style="margin: 0 auto; padding: 10px 0; color: #F00;">Hakkımızda</h1>
                    <p>
                    ...
                    <br><br>
                    abore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum
                    ...
                    from it? But who has any right to fi
